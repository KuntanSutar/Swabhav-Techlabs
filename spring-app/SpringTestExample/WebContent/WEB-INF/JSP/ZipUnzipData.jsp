...
<form:form action="${pageContext.request.contextPath}/zipUnzipAction" id="propNumInsertFormId" commandName="zipUnzipForm" autocomplete="off" method="post" enctype="multipart/form-data">
...
<p><input type="file" accept=".csv" name="file" id="propslFile" /></p>  
